    ...
    <Fade>
      <div className="border-2 border-gray-300 rounded-xl font-sourceSans3">
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-[#6C6B6B] font-normal flex items-center gap-3 mb-2"><CiLocationOn className="text-2xl" />Location: {pet?.location}</p>
            <p className="text-[#6C6B6B] font-normal flex items-center gap-3 mb-2"><CiCalendar className="text-2xl" />Birth: {pet?.date}</p>
            <p className="text-[#6C6B6B] font-normal flex items-center gap-3"><IoMdTime className="text-2xl" />Age: {pet?.age}</p>
          </div>
